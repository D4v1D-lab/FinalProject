...
namespace SacramentMeetingPlanner.Controllers
{
    public class SpeakersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Speaker,Subject")] Speakers speakers)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Speaker,Subject")] Speakers speakers)
        {
            if (id != speakers.Id)
            {
                return NotFound();
